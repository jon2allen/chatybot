#!/usr/bin/env python3
"""
Macro Expansion Test Harness
Tests the macro system independently of chatybot core
"""
...
def main():
    if len(sys.argv) != 3:
        print("Usage: python test_macro_harness.py <macro_file> <test_script>")
        print("Example: python test_macro_harness.py macro.chatdsl test_macros.chatdsl")
        sys.exit(1)
