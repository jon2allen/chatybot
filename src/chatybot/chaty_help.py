...
class HelpSystem:
    ...
    def _initialize_commands(self) -> None:
        ...
        self.register_command(CommandHelp(
            ...
            examples=["/tool on", "/tool off", "/tool list", "/tool list var=my_tools", "/tool auto on", "/tool scratch on", "/tool scratch status", "/tool scratch clean", "/tool max_turns 75", "/tool rate_limit 3", "/tool enable list_directory", "/tool disable write_file", "/tool disable all", "/tool prompt", "/tool prompt live_edit", "/tool prompt restore", "/tool retry edit", "/tool retry fix", "/tool retry run", "/tool loop", "/tool loop 50", "/tool history", "/tool history 3 var=loop_3", "/tool history current", "/tool history csv tools.csv", "/tool export csv tools.csv", "/tool replay", "/tool replay at 2 var=snap2", "/tool replay diff 1 3", "/tool replay step", "/tool replay limit=8000", '/tool {"tool": "list_directory", "arguments": {"path": "."}}'],
            see_also=["/run"]
        ))
