#!/usr/bin/env python3
"""
Macro Expansion Test Harness using Parsley
...
def main():
    if len(sys.argv) != 3:
        print("Usage: python test_macro_harness_parsley.py <macro_file> <test_script>")
        print("Example: python test_macro_harness_parsley.py macro.chatdsl test_macros.chatdsl")
        sys.exit(1)
